      ...
      <div className="max-w-6xl mx-auto">
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-100">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Price (Car)</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Price (Bus)</th>
              ...
              {trips.map((trip) => (
                <tr key={trip.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-700">
                    {trip.pickup} to {trip.drop} {trip.viaPoints.length > 0 && `via ${trip.viaPoints.join(", ")}`}
                  </td>
        ...
        {trips.length === 0 && (
          <div className="text-center py-12">
            <p className="text-gray-500">No trips available. Add a new trip to get started.</p>
          </div>
        )}
